...
# 2. Initialize Kubebuilder project (from parent directory)
cd /Users/j7m4/code/personal/op-bed
...
The Kubebuilder commands created:
- API types in `api/v1/helloworld_types.go`
- Controller logic in `internal/controller/helloworld_controller.go`
- CRD manifests in `config/crd/`
- RBAC configurations in `config/rbac/`
- Manager setup in `cmd/main.go`
